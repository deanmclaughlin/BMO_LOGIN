...
namespace BMO_Auth.Migrations
{
    ...
    [Migration("20220831203626_CreateInitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BMO_Auth.Models.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BMO_Auth.Models.Accounttype", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("BMO_Auth.Models.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("BMO_Auth.Models.Account", b =>
                {
                    b.HasOne("BMO_Auth.Models.Accounttype", "AccountType")
                        .WithMany("Accounts")
                        .HasForeignKey("AccountTypeId")
                        .IsRequired()
                        .HasConstraintName("account_ibfk_2");

                    b.HasOne("BMO_Auth.Models.Client", "Client")
                        .WithMany("Accounts")
